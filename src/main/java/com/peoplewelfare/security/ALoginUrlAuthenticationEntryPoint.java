...
public class ALoginUrlAuthenticationEntryPoint implements AuthenticationEntryPoint,
        InitializingBean {

    static Logger LOGGER = Logger.getLogger(ALoginUrlAuthenticationEntryPoint.class);
     ...
     * URL.
     */
    public ALoginUrlAuthenticationEntryPoint(String loginFormUrl) {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response,
        ...
        LOGGER.info("===================2===================="+useForward);
        String redirectUrl = null;

        if (useForward) {

            LOGGER.info(request.getScheme()+"===================3===================="+forceHttps);
    ...
    protected String buildRedirectUrlToLoginPage(HttpServletRequest request,
        ...
        LOGGER.info("=============5============"+urlBuilder.getUrl());
